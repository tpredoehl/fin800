...
\begin{document}
	...
	Given the investor has a utility function \replacedTP{chartacterized}{characterized} by non-satiation and risk aversion ($u'>0$ and $u''<0$)\todo{how is this statement related to the optimal portfolio weights?}, portfolio weights are defined by optimizing the expression below (the argument of the exponential): \vspace{-3em}\\
