...
\begin{document}
	...
	\addedTP{While the optimal portfolio $\theta_t^*$ (\ref{Optimal weight}) is indifferent to the ESG rating, the expected utility of future wealth considers the preference $b>0$ for risky assets with a higher ESG rating}
