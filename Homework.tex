...
\begin{document}
	...
	\begin{itemize}
		...
		\item \replaced[id=tp]{1-period model, starting at t}{Two periods: t = today and t+1 = end of the investment period }
		...
		\item $W_{t} = $ investable wealth (endowment at time t minus consumption \deleted[id=tp]{during the period, }$c_t$)
