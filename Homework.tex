...
\begin{align*}
	...
	&= E[(-a(\phi (R_{t+1})) - bESG_t + a(\phi (E[R_{t+1}])) + bE[ESG_t])^2]\\
	&= E[(-a \phi R_{t+1} + a \phi E[R_{t+1}])^2]\\
	&= E[a \phi (-R_{t+1} + E[R_{t+1}])^2]\\
...
The random variable $\tilde{x} = -aw_{t+1} - bESG_t$ is normally distributed with 
\begin{align*}
	E[\tilde{x}] &= -a(w_{t+1}) - bE[ESG_t]\\
	V[\tilde{x}] &= E[(\tilde{x} - E[\tilde{x}])^2]\\
	&= E[-a(w_t R_f - \phi (1+\mu+\beta x_t - R_f)) -bESG_t \\
	&+ a(w_t R_f - \phi (1+\mu+\beta x_t - R_f)) + bE[ESG_t])^2]\\
	&= E[(- a \phi \sigma_r \eta_{r, t+1} - b(ESG_t - E[ESG_t]))^2]\\
	&= E[a^2 \phi^2 \sigma_r^2 \eta_{r, t+1}^2 - (ESG_t)\\
	&= E[a^2 \phi^2 \sigma_r^2 \eta_{r, t+1}^2] + bVar(ESG_t)\\
	&= a^2 \phi^2 \sigma_r^2 E[\eta_{r, t+1}^2]\\
	&= a^2 \phi^2 \sigma_r^2
\end{align*}
