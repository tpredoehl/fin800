...
Given a fixed endowment $w_0 = y_t + \frac{y_{t+1}}{1+R}$ The optimal portfolio is determined by the IMRS (5), whereby it would be optimal to forgoe an amount $\lambda = \frac{1}{1+R}$ at time t in order to gain an amount of 1 at time t+1. 
