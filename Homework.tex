...
\begin{document}
	...
	\begin{itemize}
		...
		\item The riskless asset returns $r_{f,t+1}$ \added[id=tp]{= r_t = \text{const.}} (deterministic and known in t)
		...
		\item $W_{t} = $ investable wealth  (endowment at time t \replaced[id=tp]{after}{minus} consumption \deleted[id=tp]{during the period, }$c_t$)
