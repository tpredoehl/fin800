...
\begin{document}
	...
	\begin{align*}
		...
		u_{c_t}' &= \frac{\partial u}{\partial c_t} = \frac{1}{1-1\rho}\left[c_t^{1-\frac{1}{\rho}} + \delta c_{t+1}^{1-\frac{1}{\rho}}\right]^{\frac{1-\gamma}{1-\frac{1}{\rho}} - \frac{1-\frac{1}{\rho}}{1-\frac{1}{\rho}}} (1-\frac{1}{\rho})c_t^{-\frac{1}{\rho}}\\
		...
		\text{IES} &= \frac{\partial \ln \left(\frac{c_{t+1}}{c_t}\right)}{\partial \ln IMRS} = \rho\\
	\end{align*}
