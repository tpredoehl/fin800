...
\begin{document}
	...
	\end{align}
	\replacedTP{The overall effect of the ESG component depends on the relative importance of $b$ over $a$:}{The addition of the random non-monetary ESG effect would contribute to expected utility of future wealth for as long as $bESG_t > b^2 \sigma_{ESG}^2$.}
	\begin{itemize}
