...
\begin{document}
	...
	\added{The net ESG effect $bESG_t - b^2 \sigma_{ESG}^2$ could add to or take away from the expected utility of future wealth, }
	
	\begin{align*}
		\sigma_{ESG}^2 &= E[(ESG_t - E[ESG_t])^2]\\
		&= E[ESG_t^2 - 2 ESG_t E[ESG_t] + E[ESG_t]^2]\\
		&= E[ESG_t^2] - E[ESG_t]^2\\
		\sigma_{ESG}^2 &> 0\\
		E[ESG_t^2] &> E[ESG_t]^2\\
		\frac{E[ESG_t^2]}{E[ESG_t]^2} &> 1\\
		b^2 \sigma_{ESG}^2 &< b E[ESG_t]\\
		b E[ESG_t^2] - bE[ESG_t]^2 &< E[ESG_t]\\
		\frac{b E[ESG_t^2]}{E[ESG_t]^2} &< (1 + b)\\
		\frac{b E[ESG_t^2]}{E[ESG_t]^2} - 1&< b\\
		\frac{b E[ESG_t^2]}{E[ESG_t]^2} - \frac{E[ESG_t]^2}{E[ESG_t]^2} &< b\\
		\frac{b E[ESG_t^2] - E[ESG_t]^2}{E[ESG_t]^2} &< b\\
		\frac{b \sigma_{ESG}^2}{E[ESG_t]^2} &< b\\
	\end{align*}
