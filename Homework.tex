...
\begin{document}
	...
	A \comment{decrease in risk aversion}{interesting question: what is the direction of causality? do agents reduce risk aversion, when they observe higher returns or do returns increase when agents happen to have lower risk aversion?} $\gamma$, i.e. an increase of the IES $\frac{1}{\gamma}$ increases the preference for future consumption by a percentage equal to the sum personal time preference $\delta$ and asset return R. The less risk averse agent accepts to reduce current consumption and invests more in the risky asset. 
