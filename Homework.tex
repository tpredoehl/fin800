...
\begin{document}
	...
	Noting: (i) the investor has already decided how much to consume at time t ($c_t$) and (ii) the marginal utility of consumption is positive ($u'>0$), the agent \replacedTP{needs to allocate its investable wealth }{allocates its remaining investable wealth $W_t$} across the only two assets available in the investable universe: (i) the risk-free bond and (ii) the risky asset. The share of the available wealth attributed to the risky asset is defined as $\theta_t$. \\
