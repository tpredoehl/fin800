...
\begin{document}
	...
	The argument of the exponential within square brackets represents the \highlight{certainty equivalent ($CE$) of the random wealth $W_{t+1}^{*}$} and after substituting for $\theta_t^{*}$: \vspace{-2em} \todo{discuss: $W_t$ not a f(ESG)!}
