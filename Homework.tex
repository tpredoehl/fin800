...
\begin{document}
	...
	\begin{itemize}
		\item The expected wealth in t+1 \replacedTP{corresponds to}{is floored at} the investable wealth in t capitalized at the risk free rate plus the square of the sharpe ratio of the asset divided by the absolute risk aversion of the investor.
