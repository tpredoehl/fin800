...
\begin{align*}
	...
	\left(\frac{u_{c_t}'}{u_{c_{t+1}}'}\right)^{-\rho} &= \delta^{-\rho} \left(\frac{c_t{+1}}{c_t}\right)\\
	\delta^\rho \left(\frac{u_{c_t}'}{u_{c_{t+1}}'}\right)^{-\rho} &= \left(\frac{c_t{+1}}{c_t}\right)\\
	\rho \ln \delta - \rho \ln \left(\frac{u_{c_t}'}{u_{c_{t+1}}'}\right) &= \ln \left(\frac{c_t{+1}}{c_t}\right)\\
\end{align*}
