...
\begin{document}
	...
	\todo{elaborate!}
	\addedTP{I think here we need to expand on how the agent actually uses the ESG information. I believe that asset universe selection is key in this consideration:		\begin{itemize}
			\item agent defines Minimum Acceptable ESG Rating: MAER
			\item if $\mu_{x, ESG} < MAER$ exc
			\item ESG better than cut off
	\end{itemize}}	
