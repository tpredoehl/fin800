...
\begin{document}
	...
	\end{align}
	Given that the ESG factor does not enter the utility maximization program as a function of portfolio weights, it is irrelevant for the functional distribution of optimal wealth whether ESG is deterministic or random. 
