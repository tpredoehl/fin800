...
\begin{align*}
	...
	\frac{\partial u}{\partial c_t} &= \frac{1}{1-1\rho}\left[c_t^{1-1/\rho} + \delta c_{t+1}^{1-1/\rho}\right]^{\frac{1-\gamma}{1-1/\rho} - \frac{1-1/\rho}{1-1/\rho}} (1-1/\rho)c_t^{-1/\rho}\\
	&= \left[c_t^{1-1/\rho} + \delta c_{t+1}^{1-1/\rho}\right]^{\frac{-\gamma + 1/\rho}{1-1/\rho}} c_t^{-1/\rho}\\
	\frac{\partial u}{\partial c_{t+1}} &= \frac{1}{1-1\rho}\left[c_t^{1-1/\rho} + \delta c_{t+1}^{1-1/\rho}\right]^{\frac{1-\gamma}{1-1/\rho} - \frac{1-1/\rho}{1-1/\rho}} \delta (1-1/\rho)c_{t+1}^{-1/\rho}\\
	&= \left[c_t^{1-1/\rho} + \delta c_{t+1}^{1-1/\rho}\right]^{\frac{-\gamma + 1/\rho}{1-1/\rho}} c_t^{-1/\rho}\\
