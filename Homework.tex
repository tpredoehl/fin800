...
\begin{document}
	...
	\addTP{I think here we need to expand on how the agent actually uses the ESG information. I believe that asset universe selection is key in this consideration:
	\begin{itemize}
