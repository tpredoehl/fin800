...
\begin{document}
	...
	The optimal portfolio $\lambda$ is sensitive to changes in the ratio $\frac{c_{t+1}}{c_t} = \delta^{\frac{1}{\gamma}} (1+R)^{\frac{1}{\gamma}}$ and this ratio is sensitive to changes in $\gamma$. 
	\begin{align*}
