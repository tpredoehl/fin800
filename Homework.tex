...
Maximizing expected utility is equivalent to maximizing the objective function $$-aw_t R_f -a \phi (E[R_{t+1}] - R_f) - bESG_t + \frac{1}{2}a^2 \phi^2 \sigma_r^2$$.
...
The welfare of the investor is obtained by inserting the optimal portfolio $\phi^*$ into objective function: $$-aw_t R_f -a \phi^* (E[R_{t+1}] - R_f) - bESG_t + \frac{1}{2}a^2 \phi*^2 \sigma_r^2$$
