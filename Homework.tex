...
\begin{document}
	...
	\begin{align*}
		\delta \left(\frac{y_{t+1} + \lambda(1+R)}{y_t - \lambda}\right)^{-\lambda} &= (1+R)^{-1}\\
		\left(\frac{y_{t+1} + \lambda(1+R)}{y_t - \lambda}\right) &= \delta^{\frac{1}{\lambda}}(1+R)^{\frac{1}{\lambda}}\\
		y_{t+1} + \lambda(1+R) &= \delta^{\frac{1}{\lambda}}(1+R)^{\frac{1}{\lambda}} (y_t - \lambda)\\
		\frac{y_{t+1}}{(1+R)} + \lambda &= \delta^{\frac{1}{\lambda}}(1+R)^{\frac{1-\gamma}{\lambda}} y_t - \delta^{\frac{1}{\lambda}}(1+R)^{\frac{1-\gamma}{\lambda}} \lambda)\\
	\end{align*}
