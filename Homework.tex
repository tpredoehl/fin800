...
\begin{document}
	...
	\begin{align*}
		U(c_t, c_{t+1}) &= \frac{1}{1-\gamma} \left[c_t^{1-\frac{1}{\rho}} + \delta c_{t+1}^{1-\frac{1}{\rho}}\right]^{\frac{1-\gamma}{1-1/\rho}}\\
		...
		\text{IMRS} &= \left( \frac{u_{c_{t+1}}'}{u_{c_t}'} \right) = \delta \left(\frac{c_{t+1}}{c_t}\right)^{-1/\rho}\\
