...
\begin{document}
	...
	A \alert{decrease} in risk aversion $\gamma$, i.e. an increase of the IES $\frac{1}{\gamma}$ increases the preference for future consumption by a percentage equal to the sum personal time preference $\delta$ and asset return R. The less risk averse agent accepts to reduce current consumption and invests more in the risky asset. 
