...
\begin{document}
	...
	The variance of the optimal wealth corresponds to the squared sharpe ratio of the risky asset standardized by the quadrate of the absolute risk aversion of the investor. \addedTP{$\frac{\partial V_t (W_{t+1}^*)}{Nenner}$}
