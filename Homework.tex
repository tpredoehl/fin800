...
\end{align*}
A decrease in risk aversion $\gamma$, i.e. an increase of $\frac{1}{\gamma}$ increases the preference for future consumption by a percentage equal to the sum personal time preference $\delta$ and return on the risky asset R.
